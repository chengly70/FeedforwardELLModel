function [I_aff,I_ie,I_ee,tV,nuI,nuE]=getSinInp_internrn(frq,dc_val,Amp,Nei)
%Input: cutoff_frq (Hz); dc_val (limit of direct input); amp_rng (amplitude
%range); Nei is size of each E & I Presyn Pop,
...
%Nei is the number of BOTH presyn E and presyn I neurons. 
